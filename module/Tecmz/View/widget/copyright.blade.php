    ...
    <div class="row">
        <div class="col-md-6">
            <div class="ub-panel">
                ...
                <div class="body">
                    <div class="tw-py-1">
                        <span class="tw-font-mono">{{\ModStart\Core\Util\MetaUtil::get('APP_NAME')}}</span>
                        <span class="tw-font-mono">V{{\App\Constant\AppConstant::VERSION}}</span>
                    </div>
                    ...
                    @else
                        <div class="tw-py-1" style="height:27px;">
